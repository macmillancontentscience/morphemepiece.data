...
The goal of morphemepiece.data is to provide stable, versioned data for use in the [{morphemepiece}](https://github.com/macmillancontentscience/morphemepiece) tokenizer package.
...
It contains two functions to load data used by {morphemepiece}.
